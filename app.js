...
var express 		= 	require("express"),//mindware
	...
	//Para guardar el comentario del video...


	//Mostrar la vista del video 
	app.get("/vistaVideo", rutas.vistaVideo);
	app.post("/vistaVideo", rutas.videoPost);

	app.get('/comentarios', rutas.comentarios);
